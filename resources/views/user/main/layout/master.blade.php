...
<head>
    ...
    <link href="user/https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
    ...
    <!-- CSS only -->
    <link href="{{ asset('user/https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css')}}" rel="stylesheet"
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown me-5">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="my-3"><a class="dropdown-item" href="{{ route('user#accountChangePassword') }}"><i
                                        class="fas fa-user"></i> Account</a></li>
                                    <li class="my-3"> <a class="dropdown-item" href="{{ route('user#changePassword') }}"><i
                                        class="fas fa-key"></i> Change Password</a></li>
                                    <li class="text-center"><span class="dropdown-item" href="#">
                                            <form action="{{ route('logout') }}" method="POST">
                                                @csrf
                                                <button class="btn bg-dark text-white" type="submit"> <i
                                                        class="fas fa-right-from-bracket text-white"></i>
                                                    Logout</button>
                                            </form>
                                        </span></li>
                                </ul>
